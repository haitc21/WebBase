...
import { CommandService, MessageConstants, NotificationService, PermissionModel, PermissionService, PermissionUpdateRequestModel, RoleService, SystemConstants, UtilitiesService } from './../../../shared';
...
export class PermissionsComponent implements OnInit, OnDestroy {
  ...
  public savePermission() {
    ...
    const listPermissions: PermissionModel[] = [];
    ...
    const permissionsUpdateRequest = new PermissionUpdateRequestModel();
  ...
  fillPermissions(roleId: any) {
    ...
    this.subscription.add(this.rolesService.getRolePermissions(roleId)
      .subscribe((response: PermissionModel[]) => {
        this.selectedCreates = [];
        this.selectedUpdates = [];
        this.selectedDeletes = [];
        this.selectedViews = [];
